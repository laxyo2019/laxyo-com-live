		...
		<div class="row pb_30">
			...
			<div class="row">
				...
				<div class="col-md-9 col-lg-9 col-sm-9 effect-slide-left in">
					...
					<a href="{{url('/railway-contractors')}}">Read More >></a>
				</div>
			</div>					
		</div>
		<!-- service 2 -->
		<div class="row pb_30">
			...
			<div class="row">
				...
				<div class="col-md-9 col-lg-9 col-sm-9 effect-slide-left in">
					...
					<a href="{{url('/operation-and-maintenance')}}">Read More >></a>
				</div>
			</div>					
		</div>
		<!-- service 3 -->
    <div class="row pb_30">
			...
			<div class="row">
				...
				<div class="col-md-9 col-lg-9 col-sm-9 effect-slide-left in">
					...
					<a href="{{('/mining-services')}}">Read More >></a>
				</div>
			</div>					
		</div>
    ...
    <div class="row pb_30">
			...
			<div class="row">
				...
				<div class="col-md-9 col-lg-9 col-sm-9 effect-slide-left in">
					...
					<a href="{{url('/dredging-and-reclamation')}}">Read More >></a>
				</div>
			</div>					
		</div>
		...
		<div class="row pb_30">
			...
			<div class="row">
				...
				<div class="col-md-9 col-lg-9 col-sm-9 effect-slide-left in">
					...
					<a href="{{url('/renewable-energy-system')}}">Read More >></a>
				</div>
			</div>					
		</div>
		...
		<div class="row pb_30">
			...
			<div class="row">
				...
				<div class="col-md-9 col-lg-9 col-sm-9 effect-slide-left in">
					...
					<a href="{{url('/construction-equipment-rental-services')}}">Read More >></a>
				</div>
			</div>					
		</div>
		...
		<div class="row pb_30">
			...
			<div class="row">
				...
				<div class="col-md-9 col-lg-9 col-sm-9 effect-slide-left in">
					...
					<a href="{{url('amphibious-excavator')}}">Read More >></a>
				</div>
			</div>					
		</div>
